...
def getDefaultQss():
    ...
    return getQss(Qss.WHITE, Qss.DEEPBLUEGREEN, Qss.BLUEGREEN, Qss.LIGHTGREEN, Qss.DARKBLUEGREEN, Qss.LIGHTGRAY,
                  Qss.GRAY, "default")
...
def __getAllQss(fontLight, fontDark, normal, light, deep, disLight, disDark, themeImgDir):
    ...
    custom_label_qss_list = ["EncodeSettingsLabel", "RenderSettingsLabel", "AMDSettingsLabel", "AdvanceSettingsLabel",
                             "OutputLabel", "InputLabel", "FrameExtractSettingsLabel", "CustomEncodeSettingsLabel",
                             "NcnnRifeSettingsLabel", "NvidiaRifeSettingsLabel", "GlobalRifeSettingsLabel"]
    ...
    handleRadius = str(6)
    handleOffset = str(3)
    str1 = "QSlider{background: transparent;}" \
           "QSlider::groove:horizontal,QSlider::add-page:horizontal{height:%spx;border-radius:%spx;background:%s;}" % (
               sliderHeight, sliderRadius, normal)
    str2 = "QSlider::sub-page:horizontal{height:%spx;border-radius:%spx;background:%s;}" % (
        sliderHeight, sliderRadius, light)
    str3 = "QSlider::handle:horizontal{width:%spx;margin-top:-%spx;margin-bottom:-%spx;border-radius:%spx;" \
           "background:qradialgradient(spread:pad,cx:0.5,cy:0.5,radius:0.5,fx:0.5,fy:0.5,stop:0.6 #FFFFFF,stop:0.8 %s);}" % (
               handleWidth, handleOffset, handleOffset, handleRadius, normal)
    qss += str1 + str2 + str3
    return qss.replace("\\", "/")
