...
class WindowWithTitleBar(QFrame):
    def __init__(self, mainwidget, parent=0):
        ...
        self.m_titlebar.move_sig.connect(self.moveWindowOnTitleBar)
    ...
    def initTipLabel(self, parent):
        ...
        self.tipLabel.setGeometry(int(self.width() / 2 - self.tipLabel.width() / 2), self.tipLabel.y(),
    ...
    def moveWindowOnTitleBar(self, e: dict):
        move_x = e.get('move_x')
        move_y = e.get('move_y')
