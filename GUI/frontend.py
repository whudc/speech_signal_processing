...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.digital_sequence_textEdit = QtWidgets.QTextEdit(self.widget)
        ...
        self.digital_select_comboBox = QtWidgets.QComboBox(self.widget)
        ...
        self.digital_select_comboBox.addItem("")
        self.digital_select_comboBox.addItem("")
        self.gridLayout_3.addWidget(self.digital_select_comboBox, 0, 0, 1, 1)
        self.gridLayout_7.addLayout(self.gridLayout_3, 1, 0, 1, 1)
        self.gridLayout_6 = QtWidgets.QGridLayout()
        self.gridLayout_6.setObjectName("gridLayout_6")
        self.start_record_train_pushButton = QtWidgets.QPushButton(self.widget)
        ...
        self.train_digital_sequence_radioButton = QtWidgets.QRadioButton(self.widget)
        self.train_digital_sequence_radioButton.setObjectName("train_digital_sequence_radioButton")
        self.gridLayout_5.addWidget(self.train_digital_sequence_radioButton, 1, 0, 1, 1)
        self.train_single_digital_radioButton = QtWidgets.QRadioButton(self.widget)
        self.train_single_digital_radioButton.setObjectName("train_single_digital_radioButton")
        self.gridLayout_5.addWidget(self.train_single_digital_radioButton, 0, 0, 1, 1)
        self.gridLayout_7.addLayout(self.gridLayout_5, 1, 1, 2, 1)
        ...
        self.test_single_digital_radioButton = QtWidgets.QRadioButton(self.widget_2)
        self.test_single_digital_radioButton.setObjectName("test_single_digital_radioButton")
        self.gridLayout_11.addWidget(self.test_single_digital_radioButton, 0, 0, 1, 1)
        self.test_digital_sequence_radioButton = QtWidgets.QRadioButton(self.widget_2)
        self.test_digital_sequence_radioButton.setObjectName("test_digital_sequence_radioButton")
        self.gridLayout_11.addWidget(self.test_digital_sequence_radioButton, 1, 0, 1, 1)
        ...
        self.zh_radioButton = QtWidgets.QRadioButton(self.widget1)
        ...
        self.en_radioButton = QtWidgets.QRadioButton(self.widget1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.train_digital_sequence_radioButton.setText(_translate("MainWindow", "数字序列"))
        self.train_single_digital_radioButton.setText(_translate("MainWindow", "单个数字"))
        self.test_single_digital_radioButton.setText(_translate("MainWindow", "单个数字"))
        self.test_digital_sequence_radioButton.setText(_translate("MainWindow", "数字序列"))
